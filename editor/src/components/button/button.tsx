...
import { ButtonIconPlacement } from '$components/button/types/button-icon-placement';
...
export const Button = (props: ButtonProps): ReactElement => {
  ...
  const drawButtonContent = (): ReactElement => {
    if (props.isLoading) {
      return drawLabelWithIcon('', <SpinnerIcon width="0.8rem" height="0.8rem" />);
    }

    if (props.isCopied) {
      return drawLabelWithIcon('Copied!', <CopySuccessIcon width="0.8rem" height="0.8rem" />);
    }
