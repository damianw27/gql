...
import { SuggestionWithAccuracy } from '$components/autocomplete/types/suggestion-with-accuracy.model';
...
import { WordExtraction } from '$components/autocomplete/types/word-extraction.model';
...
export const Autocomplete = ({
  ...
  const getOptions = (): ReactElement[] => suggestions.map((suggestion, index) => assemblyOption(suggestion, index));
