...
export const examples: Example[] = [
  ...
  },
  {
    ...
    code: 'CREATE GRAPH TYPE fraudGraphType STRICT IMPORTS socialGraphType {}\n\n',
  },
  {
    name: 'Edge type example',
    code: 'CREATE EDGE TYPE\n  (:CustomerType)-[OwnsAccountType: owns]->(:AccountType)\n',
  },
  {
  ...
  },
  {
    ...
    code: 'CREATE NODE TYPE (personType: Person {name STRING , OPTIONAL birthday DATE})\n\n',
  },
];
