...
export default class GqlParserListener extends antlr4.tree.ParseTreeListener {
	...
	enterGraphPatternWhereClause(ctx) {
	}

	// Exit a parse tree produced by GqlParser#graphPatternWhereClause.
	exitGraphPatternWhereClause(ctx) {
	}
	...
	exitGeneralSetFunctionType(ctx) {
	}
	...
	enterCatalogSchemaParentAndName(ctx) {
	}

	// Exit a parse tree produced by GqlParser#catalogSchemaParentAndName.
	exitCatalogSchemaParentAndName(ctx) {
	}
	...
	enterCatalogGraphParentAndName(ctx) {
	}

	// Exit a parse tree produced by GqlParser#catalogGraphParentAndName.
	exitCatalogGraphParentAndName(ctx) {
	}
	...
	enterCatalogGraphTypeParentAndName(ctx) {
	}

	// Exit a parse tree produced by GqlParser#catalogGraphTypeParentAndName.
	exitCatalogGraphTypeParentAndName(ctx) {
	}
	...
	enterCatalogBindingTableParentAndName(ctx) {
	}

	// Exit a parse tree produced by GqlParser#catalogBindingTableParentAndName.
	exitCatalogBindingTableParentAndName(ctx) {
	}
	...
	enterCatalogProcedureParentAndName(ctx) {
	}

	// Exit a parse tree produced by GqlParser#catalogProcedureParentAndName.
	exitCatalogProcedureParentAndName(ctx) {
	}
	...
	exitGeneralLogarithmFunction(ctx) {
	}
	...
	exitNonDelimitedIdentifier(ctx) {
	}
	...
	// Enter a parse tree produced by GqlParser#bidirectionalControlCharacter.
	enterBidirectionalControlCharacter(ctx) {
	}

	// Exit a parse tree produced by GqlParser#bidirectionalControlCharacter.
	exitBidirectionalControlCharacter(ctx) {
	}


	// Enter a parse tree produced by GqlParser#comment.
	enterComment(ctx) {
	}

	// Exit a parse tree produced by GqlParser#comment.
	exitComment(ctx) {
	}
