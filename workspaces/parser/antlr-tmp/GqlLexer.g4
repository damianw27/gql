...
ESCAPED_UNICODE4_DIGIT_VALUE: REVERS_SOLIDUS 'u' DIGIT16 DIGIT16 DIGIT16 DIGIT16;
ESCAPED_UNICODE6_DIGIT_VALUE: REVERS_SOLIDUS 'u' DIGIT16 DIGIT16 DIGIT16 DIGIT16 DIGIT16 DIGIT16;

// operators
NOT_EQUALS: LEFT_ANGLE_BRACKET RIGHT_ANGLE_BRACKET;
LESS_THAN: LEFT_ANGLE_BRACKET;
GREATER_THAN: RIGHT_ANGLE_BRACKET;
LESS_THAN_OR_EQUALS: LEFT_ANGLE_BRACKET EQUALS;
GREATER_THAN_OR_EQUALS: RIGHT_ANGLE_BRACKET EQUALS;
MULTISET_ALTERNATION: VERTICAL_BAR PLUS VERTICAL_BAR;
CONCATENATION: VERTICAL_BAR VERTICAL_BAR;

// numbers
HEX_DIGIT: DIGIT16;
STANDARD_DIGIT: DIGIT10;
OCTAL_DIGIT: DIGIT8;
BINARY_DIGIT: DIGIT2;
HEX_PREFIX: '0x';
OCTAL_PREFIX: '0o';
BINARY_PREFIX: '0b';
EXACT_NUMBER_SUFIX: MM;
APPROXIMATE_NUMBER_SUFIX: F | D;
EXPONENT_SEPARATOR: E;

// strings
BYTE_SRTING_PREFIX: ('x' | 'X');
