...
public class GqlLexer extends Lexer {
	...
	public static final int
		...
		DOUBLE_QUOTED_STRING_LITERAL=386, ACCENT_QUOTED_STRING_LITERAL=387, SIMPLE_COMMENT_LITERAL=388, 
		BRACKETED_COMMNET_LITERAL=389, WS=390, WHITESPACE=391, NEW_LINE=392, CARRIAGE_RETURN=393, 
		RETURN_SIGN=394, REGULAR_IDENTIFIER=395, EXTENDED_IDENTIFIER=396, START_CHARS=397, 
		CONTINUE_CHARS=398, BIDIRECTIONAL_CONTROL_CHARACTER=399, ESCAPED_CHARS=400, 
		ESCAPED_REVERSE_SOLIDUS=401, ESCAPED_QUOTE=402, ESCAPED_SOUBLE_QUOTE=403, 
		ESCAPED_GRAVE_ACCENT=404, ESCAPED_TAB=405, ESCAPED_BACKSPACE=406, ESCAPED_NEW_LINE=407, 
		ESCAPED_CARRIAGE_RETURN=408, ESCAPED_FORM_FEED=409, ESCAPED_UNICODE4_DIGIT_VALUE=410, 
		ESCAPED_UNICODE6_DIGIT_VALUE=411, GQL_LANGUAGE_CHAR=412, GQL_SPECIAL_CHAR=413;
